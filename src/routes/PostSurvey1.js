...
//   //   const dpARank = surveyData['rank-trustworthy'].indexOf('DP A') + 1;
//   //   const dpBRank = surveyData['rank-trustworthy'].indexOf('DP B') + 1;
//   //   const dpCRank = surveyData['rank-trustworthy'].indexOf('DP C') + 1;
//   //   const dpDRank = surveyData['rank-trustworthy'].indexOf('DP D') + 1;

//   //   updateTrustworthyRank(docID, dpARank, dpBRank, dpCRank, dpDRank);

//   //   // 사용자가 선택한 랭킹으로 상태 업데이트
//   //   setCurrentRanking(surveyData['rank-trustworthy']);
//   // };
...
//                       <img src={getImagePath(imgTitles[0])}
// alt={imgTitles[0]} style={{ width: '260px', height: '220px' }} />
//                       <h4>DP A</h4>
//                     </div>
//                     {/* imgB */}
//                     <div className="column" style={{ marginRight: '20px', marginBottom: '9px' }}>
//                       <img src={getImagePath(imgTitles[1])} alt={imgTitles[1]}
// style={{ width: '260px', height: '220px' }} />
//                       <h4>DP B</h4>
//                     </div>
//                     {/* imgC */}
//                     <div className="column" style={{ marginRight: '20px', marginBottom: '9px' }}>
//                       <img src={getImagePath(imgTitles[2])} alt={imgTitles[2]}
//  style={{ width: '260px', height: '220px' }} />
//                       <h4>DP C</h4>
//                     </div>
//                     {/* imgD */}
//                     <div className="column" style={{ marginRight: '20px', marginBottom: '9px' }}>
//                       <img src={getImagePath(imgTitles[3])} alt={imgTitles[3]}
// style={{ width: '260px', height: '220px' }} />
//                       <h4>DP D</h4>
//                     </div>
//                   </div>
